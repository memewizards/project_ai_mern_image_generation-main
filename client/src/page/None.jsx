    ...
    <div className="d-flex flex-column h-100">
      <main role="main" className="flex-shrink-0">
        <div className="container">
          <h1 className="mt-5">View - For free plan customers only</h1>
          <p className="lead">
            If you're able to view this page - Success! You have a free plan.
          </p>
          <p>
            Update the content on this page by editing the 
            file
          </p>
          <p>
